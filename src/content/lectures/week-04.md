...
- a working definition of "last minute" as a design constraint, not a
  personal failing
- what each tool is actually good at, versus what it's good at *sounding*
  good at
- where the seams show, and why that's the marker's job to find, not yours to
  hide
- next week: putting the whole stack in front of a real deadline
